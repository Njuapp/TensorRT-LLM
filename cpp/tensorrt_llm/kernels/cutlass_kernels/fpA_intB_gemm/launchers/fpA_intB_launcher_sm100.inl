 ...
 */
     ...
     char* workspace, size_t workspace_bytes, cudaStream_t stream, int* occupancy)
 {
                       ...
                       ActivationType>)
     {
         ...
         using EVT_bias_addition = cutlass::epilogue::fusion::Sm100EVT<
             cutlass::epilogue::fusion::Sm100Compute<cutlass::homogeneous_multiply_add, CutlassOutputType, ElementCompute,
                 RoundStyle>,                                                    // alpha * acc + bias
             cutlass::epilogue::fusion::Sm100ScalarBroadcast<ElementAccumulator>, // alpha
             cutlass::epilogue::fusion::Sm100AccFetch,                            // acc
             cutlass::epilogue::fusion::Sm100ColBroadcast<0, TileShape, CutlassBiasType, CutlassBiasType,
                 Stride<_1, _0, _0>,
                 AlignmentBias> // bias
             >;
     ...
     throw std::runtime_error(
         "[TensorRT-LLm Error][fpA_intB Runner] Please recompile with support for blackwell by passing 100-real as an arch "
         "to build_wheel.py.");
